    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('data_needed', models.ManyToManyField(null=True, related_name='data_needed', to='atc.DataNeeded', verbose_name='Data Needed')),
                ('data_to_enrich', models.ManyToManyField(blank=True, null=True, related_name='data_to_enrich', to='atc.DataNeeded', verbose_name='Data to Enrich')),
                ('new_field', models.ManyToManyField(blank=True, null=True, related_name='new_field', to='atc.LogField', verbose_name='New field(s)')),
                ('references', models.ManyToManyField(blank=True, null=True, to='atc.References', verbose_name='References(s)')),
                ('requirement', models.ManyToManyField(blank=True, null=True, related_name='_enrichment_requirement_+', to='atc.Enrichment', verbose_name='Requirement(s)')),
            ],
            options={
