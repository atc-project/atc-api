# Generated by Django 2.2.4 on 2019-08-07 15:31
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.OneToOneField(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='category', to='atc.Category', verbose_name='Category')),
                ('channel', models.OneToOneField(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='channel', to='atc.Channel', verbose_name='Channel')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('reference', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='reference', to='atc.Reference', verbose_name='Reference(s)')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('event_id', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='atc.EventID', verbose_name='Event ID(s)')),
                ('reference', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='atc.Reference', verbose_name='Reference(s)')),
        ...
        migrations.AddField(
            ...
            name='log_field',
            field=models.OneToOneField(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='log_field', to='atc.LogField', verbose_name='Log Field(s)'),
        ),
        migrations.AddField(
            model_name='dataneeded',
            name='log_type',
            field=models.OneToOneField(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='log_type', to='atc.LogType', verbose_name='Log Type'),
        ),
        migrations.AddField(
            model_name='dataneeded',
            name='logging_policy',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='loggin_policy', to='atc.LoggingPolicy', verbose_name='Logging Policy(ies)'),
        ),
        migrations.AddField(
            model_name='dataneeded',
            name='platform',
            field=models.OneToOneField(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='platform', to='atc.Platform', verbose_name='Platform'),
        ),
        migrations.AddField(
            model_name='dataneeded',
            name='provider',
            field=models.OneToOneField(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='provider', to='atc.Provider', verbose_name='Provider'),
        ),
        migrations.AddField(
            model_name='dataneeded',
            name='reference',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='atc.Reference', verbose_name='Reference(s)'),
        ),
    ]
